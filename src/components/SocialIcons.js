...
const SocialIcons = () => {
  return (
    <div className="absolute items-center right-8 bottom-1 flex flex-col justify-center overflow-hidden lg:hidden">
      ...
      <motion.a
        href="https://www.youtube.com/@CodeUnlocked0.2"
        target={"_blank"}
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.9 }}
        className="w-6 mb-3"
      ...
      <motion.a
        href="https://www.pinterest.com/codeunlocked001/"
        target={"_blank"}
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.9 }}
        className="w-6 mb-3"
      ...
      <motion.a
        href="https://github.com/codeunlocked2"
        target={"_blank"}
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.9 }}
        className="w-6 mb-3"
      ...
      <span className="h-24 bg-dark dark:bg-light w-0.5"></span>
    </div>
  );
};
