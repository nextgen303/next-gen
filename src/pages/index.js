    ...
    <>
        ...
        <Layout className="py-0 sm:py-0 h-auto">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 flex flex-col items-center self-center lg:text-center lg:w-full lg:order-2">
              <AnimatedText
                text="Hey👋 I'm a web developer ready to assist you!"
              ...
              <p className="my-4 text-base dark:text-light/60 font-medium md:text-sm sm:text-xs">
                As a skilled frontend web developer, I specialize in creating
                advanced web applications. Explore my recent projects and
                articles highlighting my Next.js and web development expertise.
              </p>
              ...
              <div className="flex items-center self-start mt-3 lg:self-center">
                ...
                <Link
                  className="ml-4 text-lg font-semibold capitalize text-dark dark:text-light p-2 px-6 border-2 border-dark dark:border-light rounded-lg hover:shadow-md md:p-2 md:px-4 md:text-base  transition xs:text-sm"
                  href="/projects"
                >
                  {" "}
                  Recent Works{" "}
            ...
            <div className="w-1/2 h-auto rounded-2xl lg:w-2/3 md:w-full sm:w-full xs:w-full">
              <Image
                src={profilePic}
                alt="devashiq"
                className="w-[100%] lg:w-full h-auto rounded-xl"
                priority
      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className="pt-0 lg:pt-32 sm:pt-0">
          <h1 className="text-8xl font-bold text-dark/10 dark:text-light/20 rounded-2xl xl:text-5xl lg:text-6xl md:text-5xl sm:text-3xl">
            {" "}
            Introduce
          </h1>
          ...
          <div className="flex items-center justify-between w-full pt-16 xs:pt-16 lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center ">
              <h1 className="flex items-center mb-3 self-start font-bold text-3xl text-black/70 dark:text-light/70 lg:self-center md:text-3xl sm:text-xl">
                Hello, Iʼm AshiQur Rahman
              </h1>
              <AnimatedText
              ...
              />
              <p className="my-4 text-base dark:text-light/60 font-medium md:text-sm sm:text-xs">
                Iʼm a dedicated frontend web developer with a passion for
                crafting engaging web experiences. With a focus on creating
                innovative solutions, Iʼm here to bring your digital ideas to
                life.
              </p>
          ...
          <div className="grid grid-cols-12 gap-16 xs:gap-4 lg:gap-8 gap-y-16 items-center justify-between mt-32 lg:mt-24 xs:mt-16">
            <div className="col-span-4 lg:col-span-6 md:col-span-6 xs:col-span-6  items-end justify-center text-dark dark:text-light rounded-lg px-8 py-4 border border-solid hover:bg-gray-100 dark:hover:bg-light/10 duration-300">
              ...
              <h2 className="text-xl font-medium capitalize text-dark/75 dark:text-light/75 lg:text-base md:text-sm sm:text-xs ">
                Completed Projects
              </h2>
            </div>
      ...
      <main className="w-full items-center justify-center">
        <Layout className="pt-16 lg:pt-0 sm:pt-0 ">
          <h1 className="text-8xl font-bold text-dark/10 dark:text-light/20 rounded-2xl  pb-20 sm:pb-10 xl:text-5xl lg:text-6xl md:text-5xl sm:text-3xl">
            {" "}
            Services
          </h1>
          ...
          >
            <li className="rounded-2xl border border-gray-200 dark:border-light-200 dark:border-light/20  p-5 group hover:bg-gray-100 dark:hover:bg-light/10 duration-300 cursor-pointer">
              ...
              <h1 className="pt-4 text-2xl font-bold sm:text-xl line-clamp-1">
                Web Design
              </h1>

              <p className="pt-2 text-sm font-semi line-clamp-2">
                I specialize in crafting exceptional web designs that place a
                strong emphasis on enhancing user experiences.
              </p>
            </li>
      ...
      <main className="w-full flex flex-col items-center justify-center">
        <Layout className="pt-16 lg:pt-0 sm:pt-0">
          <h1 className="text-8xl font-bold text-dark/10 dark:text-light/20 rounded-2xl  pb-20 sm:pb-10 xl:text-5xl lg:text-6xl md:text-5xl sm:text-4xl">
            {" "}
            Projects
          </h1>
